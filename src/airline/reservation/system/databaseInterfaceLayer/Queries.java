...
class Queries {
    ...
    static final String GET_PASSENGER_BY_ID = "SELECT * FROM passenger WHERE p_id = ?";
    ...
    static final String INSERT_FLIGHT = "INSERT INTO flight (origin, destination, departure_time, capacity, price) VALUES(?, ?, ?, ?, ?)";
